...
---@enum ENiagaraReorientedRibbonsDirectLightingMode
ENiagaraReorientedRibbonsDirectLightingMode = {
    Off = 0,
    On = 1,
    Inline = 2,
...
---@enum ENiagaraReorientedSpritesDirectLightingMode
ENiagaraReorientedSpritesDirectLightingMode = {
    Off = 0,
    On = 1,
    Inline = 2,
...
---@enum ENiagaraReorientedSpritesSortMode
ENiagaraReorientedSpritesSortMode = {
    Unordered = 0,
    Sort = 1,
    WBOIT = 2,
